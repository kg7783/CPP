...
//Scene textures
static LTexture_33 gPromptTextTexture;
static LTexture_33 gDataTextures[ TOTAL_DATA ];

//Data points
static Sint32 gData[ TOTAL_DATA ];

LTexture_33::LTexture_33()
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool LTexture_33::loadFromFile( std::string path )
{
...
#if defined(SDL_TTF_MAJOR_VERSION)
bool LTexture_33::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
	//Get rid of preexisting texture
	free();
...
void LTexture_33::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
	//Modulate texture rgb
	SDL_SetTextureColorMod( mTexture, red, green, blue );
}

void LTexture_33::setBlendMode( SDL_BlendMode blending )
{
	//Set blending function
	SDL_SetTextureBlendMode( mTexture, blending );
}
		
void LTexture_33::setAlpha( Uint8 alpha )
{
	//Modulate texture alpha
	SDL_SetTextureAlphaMod( mTexture, alpha );
}

void LTexture_33::render( int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
int LTexture_33::getWidth()
{
	return mWidth;
}

int LTexture_33::getHeight()
{
	return mHeight;
}
...
bool loadMedia()
{
	...
	SDL_RWops* file = SDL_RWFromFile( getFilePath("nums.bin").c_str(), "r+b" );
	...
	if( file == NULL )
	{
		...
		file = SDL_RWFromFile( getFilePath("nums.bin").c_str(), "w+b" );
		if( file != NULL )
		{
...
int _33_file_reading_and_writing()
{
