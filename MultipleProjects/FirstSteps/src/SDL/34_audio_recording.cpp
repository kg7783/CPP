...
static SDL_Color gTextColor = { 0, 0, 0, 0xFF };

//Prompt texture
static LTexture_34 gPromptTexture;

//The text textures that specify recording device names
static LTexture_34 gDeviceTextures[ MAX_RECORDING_DEVICES ];
...
static Uint8* gRecordingBuffer = NULL;

//Size of data buffer
static Uint32 gBufferByteSize = 0;

//Position in data buffer
static Uint32 gBufferBytePosition = 0;

//Maximum position in data buffer for recording
static Uint32 gBufferByteMaxPosition = 0;

LTexture_34::LTexture_34()
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool LTexture_34::loadFromFile( std::string path )
{
...
#if defined(SDL_TTF_MAJOR_VERSION)
bool LTexture_34::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
	//Get rid of preexisting texture
	free();
...
void LTexture_34::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
	//Modulate texture rgb
	SDL_SetTextureColorMod( mTexture, red, green, blue );
}

void LTexture_34::setBlendMode( SDL_BlendMode blending )
{
	//Set blending function
	SDL_SetTextureBlendMode( mTexture, blending );
}
		
void LTexture_34::setAlpha( Uint8 alpha )
{
	//Modulate texture alpha
	SDL_SetTextureAlphaMod( mTexture, alpha );
}

void LTexture_34::render( int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
int LTexture_34::getWidth()
{
	return mWidth;
}

int LTexture_34::getHeight()
{
	return mHeight;
}
...
bool loadMedia()
{
	...
	//Open the font
	gFont = TTF_OpenFont( getFilePath("lazy.ttf").c_str(), 28 );
	if( gFont == NULL )
	{
...
int _34_audio_recording()
{
	...
	else
	{
		...
		{	
			...
			RecordingState_34 currentState = SELECTING_DEVICE;
