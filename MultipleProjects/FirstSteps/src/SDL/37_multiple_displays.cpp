...
//Our custom window
static LWindow_37 gWindow;

//Display data
static int gTotalDisplays = 0;
static SDL_Rect* gDisplayBounds = NULL; 

LWindow_37::LWindow_37()
{
...
void LWindow_37::handleEvent( SDL_Event& e )
{
	//Caption update flag
...
int LWindow_37::getWidth()
{
	return mWidth;
}

int LWindow_37::getHeight()
{
	return mHeight;
}

bool LWindow_37::hasMouseFocus()
{
	return mMouseFocus;
}

bool LWindow_37::hasKeyboardFocus()
{
	return mKeyboardFocus;
}

bool LWindow_37::isMinimized()
{
	return mMinimized;
}

bool LWindow_37::isShown()
{
	return mShown;
}
