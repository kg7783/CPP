...
//Scene textures
static LTexture_40 gFooTexture;

LTexture_40::LTexture_40()
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool LTexture_40::loadFromFile( std::string path )
{
	//Load pixels
...
bool LTexture_40::loadPixelsFromFile( std::string path )
{
...
bool LTexture_40::loadFromPixels()
{
...
#if defined(SDL_TTF_MAJOR_VERSION)
bool LTexture_40::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
...
void LTexture_40::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
	//Modulate texture rgb
	SDL_SetTextureColorMod( mTexture, red, green, blue );
}

void LTexture_40::setBlendMode( SDL_BlendMode blending )
{
	//Set blending function
	SDL_SetTextureBlendMode( mTexture, blending );
}
		
void LTexture_40::setAlpha( Uint8 alpha )
{
	//Modulate texture alpha
	SDL_SetTextureAlphaMod( mTexture, alpha );
}

void LTexture_40::render( int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
int LTexture_40::getWidth()
{
	return mWidth;
}

int LTexture_40::getHeight()
{
	return mHeight;
}

Uint32* LTexture_40::getPixels32()
{
	Uint32* pixels = NULL;
...
Uint32 LTexture_40::mapRGBA( Uint8 r, Uint8 g, Uint8 b, Uint8 a )
{
	Uint32 pixel = 0;
...
bool loadMedia()
{
	...
	if( !gFooTexture.loadPixelsFromFile( getFilePath("foo.png").c_str() ) )
	{
