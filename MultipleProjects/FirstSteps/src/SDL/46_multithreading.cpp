...
//Scene textures
static LTexture_46 gSplashTexture;

LTexture_46::LTexture_46()
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool LTexture_46::loadFromFile( std::string path )
{
	//Load pixels
...
bool LTexture_46::loadPixelsFromFile( std::string path )
{
...
bool LTexture_46::loadFromPixels()
{
...
#if defined(SDL_TTF_MAJOR_VERSION)
bool LTexture_46::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
...
bool LTexture_46::createBlank( int width, int height, SDL_TextureAccess access )
{
	//Get rid of preexisting texture
	free();
...
void LTexture_46::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
	//Modulate texture rgb
	SDL_SetTextureColorMod( mTexture, red, green, blue );
}

void LTexture_46::setBlendMode( SDL_BlendMode blending )
{
	//Set blending function
	SDL_SetTextureBlendMode( mTexture, blending );
}

void LTexture_46::setAlpha( Uint8 alpha )
{
	//Modulate texture alpha
	SDL_SetTextureAlphaMod( mTexture, alpha );
}

void LTexture_46::render( int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
void LTexture_46::setAsRenderTarget()
{
	//Make self render target
	SDL_SetRenderTarget( gRenderer, mTexture );
}

int LTexture_46::getWidth()
{
	return mWidth;
}

int LTexture_46::getHeight()
{
	return mHeight;
}

Uint32* LTexture_46::getPixels32()
{
	Uint32* pixels = NULL;
...
Uint32 LTexture_46::getPixel32( Uint32 x, Uint32 y )
{
...
Uint32 LTexture_46::mapRGBA( Uint8 r, Uint8 g, Uint8 b, Uint8 a )
{
	Uint32 pixel = 0;
...
bool LTexture_46::unlockTexture()
{
	bool success = true;
...
void LTexture_46::copyRawPixels32( void* pixels )
{
	//Texture is locked
	if( mRawPixels != NULL )
	{
...
bool loadMedia()
{
	...
	//Load splash texture
	if( !gSplashTexture.loadFromFile( getFilePath("splash_46.png").c_str() ) )
	{
