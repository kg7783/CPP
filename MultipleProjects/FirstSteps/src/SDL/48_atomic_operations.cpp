...
//Scene textures
static LTexture_48 gSplashTexture;

//Data access spin lock
static SDL_SpinLock gDataLock = 0;

//The "data buffer"
static int gData = -1;

LTexture_48::LTexture_48()
{
	//Initialize
	mTexture = NULL;
	mWidth = 0;
...
bool LTexture_48::loadFromFile( std::string path )
{
	//Load pixels
...
bool LTexture_48::loadPixelsFromFile( std::string path )
{
...
bool LTexture_48::loadFromPixels()
{
...
#if defined(SDL_TTF_MAJOR_VERSION)
bool LTexture_48::loadFromRenderedText( std::string textureText, SDL_Color textColor )
{
...
bool LTexture_48::createBlank( int width, int height, SDL_TextureAccess access )
{
	//Get rid of preexisting texture
	free();
...
void LTexture_48::setColor( Uint8 red, Uint8 green, Uint8 blue )
{
	//Modulate texture rgb
	SDL_SetTextureColorMod( mTexture, red, green, blue );
}

void LTexture_48::setBlendMode( SDL_BlendMode blending )
{
	//Set blending function
	SDL_SetTextureBlendMode( mTexture, blending );
}

void LTexture_48::setAlpha( Uint8 alpha )
{
	//Modulate texture alpha
	SDL_SetTextureAlphaMod( mTexture, alpha );
}

void LTexture_48::render( int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
void LTexture_48::setAsRenderTarget()
{
	//Make self render target
	SDL_SetRenderTarget( gRenderer, mTexture );
}

int LTexture_48::getWidth()
{
	return mWidth;
}

int LTexture_48::getHeight()
{
	return mHeight;
}

Uint32* LTexture_48::getPixels32()
{
	Uint32* pixels = NULL;
...
Uint32 LTexture_48::getPixel32( Uint32 x, Uint32 y )
{
...
Uint32 LTexture_48::mapRGBA( Uint8 r, Uint8 g, Uint8 b, Uint8 a )
{
	Uint32 pixel = 0;
...
bool LTexture_48::unlockTexture()
{
	bool success = true;
...
void LTexture_48::copyRawPixels32( void* pixels )
{
	//Texture is locked
	if( mRawPixels != NULL )
	{
...
bool loadMedia()
{
	...
	//Load splash texture
	if( !gSplashTexture.loadFromFile( getFilePath("splash_48.png").c_str() ) )
	{
